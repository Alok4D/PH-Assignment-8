...
const ViewDetailsTwo = () => {
    ...
    const detailsTwo =biodata.find(item => item.id == idInt);
    // console.log(biodata);
    // console.log(detailsTwo);
  
    const { bookName, author, image, totalPages, rating, category, tags, publisher, yearOfPublishing, review  } = detailsTwo;
